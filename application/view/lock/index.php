...
<head>
    <meta charset="UTF-8">
    <title><?php Config::get('SITE_NAME') ?></title>
    ...
    <!-- Theme style -->
    <link href="<?php echo URL; ?>css/lockscreen.css" rel="stylesheet" type="text/css"/>
...
<div id="main" class="center">
    ...
    <div class="headline text-center">
        <p> <?php echo Config::get('SITE_NAME') ?></p>
    </div>
    <!-- /.headline -->
    ...
    <div class="text-center" style="margin-bottom: 10px;">
        <td>
            <button class="btn btn-info disabled">Your Session was locked!<br>Please enter your password to continue
            </button>
        </td>
    </div>
    <!-- /.headline -->
    ...
    <div class="lockscreen-item">
        ...
        <div class="lockscreen-image">
            <img src="<?php echo Session::get('user_gravatar_image_url') ?>" alt="user image"/>
        </div>
        <!-- /.lockscreen-image -->

        <!-- lockscreen credentials (contains the form) -->
        <div class="lockscreen-credentials">
            <form action="<?php echo Config::get('URL'); ?>lock/unlock" method="post">
                <div class="input-group">
                    <input style="display:none;" type="text" name="user_name"
                           value="<?php echo Session::get('user_name'); ?>" placeholder="Username or email" required/>
    ...
    <div class="lockscreen-link">
        <a href="<?php echo URL; ?>login/logout">Or sign in as a different user</a>
    </div>
</div>
<!-- /.center -->
